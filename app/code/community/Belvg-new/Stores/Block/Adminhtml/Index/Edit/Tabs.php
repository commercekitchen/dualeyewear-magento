...
class Belvg_Stores_Block_Adminhtml_Index_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    {        
        ...
        $this->setTitle(Mage::helper('core')->__('Change Store'));
    }
    ...
    protected function _prepareLayout()
    {
        $this->addTab('general', array(
            ...
            'content'   => $this->getLayout()->createBlock('stores/adminhtml_index_edit_tab_general')->toHtml(),
        ));
        
        //Add Serializer for Product Grid and Creating Product Tab
		
		$products_grid = $this->getLayout()->createBlock('stores/adminhtml_index_edit_tab_products', 'stores_edit_tab_products');
        ...
        $this->addTab('media', array(
            ...
            'content'   => $this->getLayout()->createBlock('stores/adminhtml_index_edit_tab_media')->toHtml(),
        ));
